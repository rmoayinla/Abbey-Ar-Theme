...
if( function_exists( "abbey_show_address" ) ) :
	function abbey_show_address( $contact ){
...
if( function_exists( "abbey_show_telephone" ) ) :
	function abbey_show_telephone( $contact ){
		echo '
				...
				<div class="no-border">
					...
					<div class="col-xs-8 col-md-12 col-sm-12" id="admin-info">
						...
						<a href="<?php echo esc_url( $defaults["admin"]["url"] ); ?>" class="btn btn-block btn-primary">
							<?php _e( "Visit Author page", "abbey" ); ?> </a>
					</div>
...
endif; //endif function exists abbey_slide_default_caption //

if( !function_exists( "abbey_slide_caption" ) ) :
...
if( !function_exists( "abbey_front_page_slides" ) ) : 
...
endif; //endif function exists abbey_show_social_contacts //
