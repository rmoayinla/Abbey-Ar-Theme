<?php
/*
* Abbey theme default header template 
* this template file is used sitewide to display site menu, banner etc. 
*
*/
?>
...
<html <?php language_attributes(); ?> class="">
	<head>
		...
		<?php do_action( "abbey_theme_header_meta_tags" ); ?>
	...
	<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
		...
		<div class="container-fluid" id="site-wrapper"><!--this div closes in footer.php -->
